...
<head>
    ...
    <title>Foursquare YC - Camp</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Create New Camp</h1>

                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-body p-0">
                            <!-- Nested Row within Card Body -->
                            <div class="row">
                                <div class="col-lg-6 d-none d-lg-block d-lg-flex justify-content-center align-items-center">
                                    <img src="img/undraw_camping_noc8.svg" style="max-width: 400px; max-height: auto;"/>
                                </div>
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Create camp now!</h1>
                                        </div>
                                        <form class="user">
                                            <div class="form-group">
                                                <label for="campName">Camp Name</label>
                                                <input type="text" class="form-control form-control-user" id="campName"
                                                    placeholder="Camp Name eg. KC 2021">
                                            </div>
                                            <div class="form-group">
                                                <label for="campTheme">Camp Theme</label>
                                                <input type="text" class="form-control form-control-user" id="campTheme"
                                                    placeholder="Theme">
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="date" class="form-control form-control-user" id="endDate"
                                                        placeholder="End date">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="campTheme">Regular Registration Amount</label>
                                                <input type="text" class="form-control form-control-user" id="rrFee"
                                                    placeholder="eg. 5000">
                                            </div>

                                            <a class="btn btn-primary btn-user btn-block" id="loaderButton" style="display: none">
                                                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                                                Loading...
                                            </a>
                                            
                                            <a id="createCampButton" class="btn btn-primary btn-user btn-block">
                                                Create camp now
                                            </a>
                                            <!--hr-->
