...
<head>
    ...
    <title>Foursquare YC - Users</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="border border-primary campList">
                                <!--p class="p-3 border text-primary camps" style="margin: 0; cursor: pointer">KC 2021</p>
                                <p class="p-3 border text-primary camps" style="margin: 0; cursor: pointer">KC 2020</p-->
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary d-flex justify-content-between align-items-center">
                                        <i class="fas fa-arrow-left" id="backToUserList" style="cursor: pointer">  User History </i> 
                                        
                                        <a class="btn btn-sm btn-primary" id="getQRCodeBtn"><i class="fas fa-eye" style="cursor: pointer"></i>  QR</a>
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <h2 id="userIdHolder" style="display: none"><?php echo $userId ?></h2>
